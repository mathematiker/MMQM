...
\begin{st}
Seien $A_k: D_k \subset H_k \to H_k$ w.s.a. für $k=1,...,n$. Dann $A_1 + A_2 + ... +A_n$ wesentlich selbstadjungiert  auf $D_1 \otimes D_2 \otimes ... \otimes D_n$ und
\[
...
\]
Dann ist $U(t)$ eine s.s.u.G. die $D:= D_1 ßotimes ... \otimes D_n$ invariant lässt und für $\phi \in D$ gilt
\[
