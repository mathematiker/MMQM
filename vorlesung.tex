...
\end{st}
\begin{proof}
vgl. Theorem 7.2 aus dem Vorlesungsskript.
\end{proof}
...
\end{align*}
ist $s= \sum_{k=1}^N \alpha_k \chi_{E_k}$ eine messbare Elementarfunktion in Standarddarstellung (d.h. $E_k = \rho^{-1}(\{\alpha_k\})$, dann
